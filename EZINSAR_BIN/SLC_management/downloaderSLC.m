...
btdownloadapidownloaderorbits = uibutton(glapidownloader,'Text','Download orbit files from ASF server (based on the downloaded files)','WordWrap','on','ButtonPushedFcn', @(btn,event) download_orbit(btn,event));
btdownloadapidownloaderorbits.Layout.Row = [18 19];
btdownloadapidownloaderorbits.Layout.Column = [5];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function download_orbit(btn,event)
