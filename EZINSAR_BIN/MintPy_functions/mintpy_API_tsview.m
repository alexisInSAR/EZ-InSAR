...
%   mintpy_API_tsview(src,evt,action,miesar_para)
%       [src]           : callback value
%       [evt]           : callback value
%       [action]        : name of the action to perform (string value)
%       [miesar_para]   : user parameters (struct.)
%
%       Function to interface the tsview.py commands from MintPy. 
%          
...
%
%   Examples and parameter descriptions from MintPy tsview.py script: https://github.com/insarlab/MintPy
