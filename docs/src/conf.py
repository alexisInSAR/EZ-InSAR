...
from ezinsar import __namePackage__ as project
from ezinsar import __copyrightPackage__ as copyright
from ezinsar import __versionPackage__ as version 
from ezinsar import __authorPackage__ as author
...
html_logo = "private/EZ_InSAR_logo_whiteback.png"
...
_common_args = [
    f'--html-viewsource-base=https://github.com/alexisInSAR/EZ-InSAR/tree/{_git_reference}',
...
pydoctor_args = {
    'main': [
        ...
        '--project-name=EZ-InSAR',
        f'--project-version={version}',
        '--docformat=google', 
        '--intersphinx=https://docs.python.org/3/objects.inv',
        '--theme=readthedocs',
        '--project-url=../index.html',
        f'{_ezinsar_root}/src/ezinsar',
        ] + _common_args,
    }
