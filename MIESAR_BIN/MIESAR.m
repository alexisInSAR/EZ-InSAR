...
switch action
    ...
    case 'information'
        ...
        si = [sprintf('About:\n'),...
            sprintf('\n------------------------\n'),...
            sprintf('\n'),...
            sprintf('The MIESAR is a Matlab toolbox that make a link between the ISCE processor and StaMPS. It allows to compute the displacements from Sentinel-1 data using the no-convential approaches PS and SBAS.\n'),...
            sprintf('\n'), ...
    ...
    case 'quit'
        ...
        answer = questdlg('Are you sure to quit MIESAR?', ...
            'Quit?', ...
            'Quit','Return','Return');
        switch answer
            case 'Quit'
