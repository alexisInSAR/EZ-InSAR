...
"""
Module to pre-process the RSAT2 SLC stack

The module allows to pre-process the RSAT2 SLC stack, directly for an `EIjob`
...
def commputecoarsenetworkSM(pathSLC,bbox,polarisation,
        ...
        """Compute the potential best reference date for a RSAT2 network, ONLY FOR SM.

        The function computes the the potential best reference date for a RSAT2 network, ONLY FOR SM.
