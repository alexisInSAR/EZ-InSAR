...
"""
Module to pre-process the COSM-SkyMed Second Generation SLC stack

The module allows to pre-process the COSM-SkyMed Second Generation SLC stack, directly for an `EIjob`
...
def commputecoarsenetworkSM(pathSLC,bbox,polarisation,
        ...
        """Compute the potential best reference date for a COSM-SkyMed Second Generation network, ONLY FOR SM.

        The function computes the the potential best reference date for a COSM-SkyMed Second Generation network, ONLY FOR SM.
