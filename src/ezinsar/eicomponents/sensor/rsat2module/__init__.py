"""
Module for the RadarSAT files

The module allows to manage RadarSAT files 
...
__namePackage__ = 'EZ-InSAR RADARSAT-2 Module'
...
__versionPackage__ = '1.0.0 Dec. 2024'
"""str: Current version of the Python package
"""

## Message 
# print('INFO: Load the EZ-InSAR RADARSAT-2 Module Version %s %s' % (__versionPackage__, __copyrightPackage__))